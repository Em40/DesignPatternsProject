    ...
    class MenuHelpers
    {
        ...
        public static void AuthenticateUserMenu()
        {
            do
            {
                ...
                while (!int.TryParse(Console.ReadLine(), out choice) || !Enum.IsDefined(typeof(PersonRole), choice));
        ...
        public static void PrintMenu(ChooseMenuItemAggregate menuItems, out int choice)
        {
            ...
            do
            {
                ...
                Console.WriteLine("\n0.LogoutMe");
            } while (!int.TryParse(Console.ReadLine(), out choice) || menuItems.Count < choice || choice < 0);
        }
    }
}
